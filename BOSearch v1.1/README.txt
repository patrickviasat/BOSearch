...
2. Run BOSearch
3. The application should automatically pull today's backorder report, which you can see in the "Selected File:" line
...
4. Input your job number in the "Enter Job Number:" field.
5. Hit enter or "Get Components"
6. Wait a few moments for the application to scrub the excel sheet.
7. The program will generate a table with the backordered components for your job number!
   - If desired, you can hit "Save as Excel File" to save the table as an excel file.
8. Close out of the table and repeat the procedure with a new job number.
9. Close out of the whole application when finished.
